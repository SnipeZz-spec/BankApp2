...
public class RemittanceCard {
    ...
    public void remittanceOperation(HashMap<Integer, GeneralCard> cardList, PurchasesHashMap purchasesHashMap) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (cardTo == 0) {
                        break;
                    } else if (cardTo < 10000000 || cardTo > 99999999 || (cardTo == cardFrom)) {
                        System.out.println("Некорректное значение! Повторите ввод");
                        continue;
                    }
                    ...
                    System.out.println("Перевод на сумму " + sum + " рублей выполнен успешно!");
                    ...
                    purchasesHashMap.putInServiceBase("Перевод", sum);
                    break;
                }
            break;
            }
